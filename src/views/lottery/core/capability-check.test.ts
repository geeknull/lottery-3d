...
const ALL_OK: CapabilityEnv = { secureContext: true, broadcastChannel: true, indexedDB: true }
...
describe('checkCapabilities', () => {
  ...
  it('多项缺失时全部列出', () => {
    const issues = checkCapabilities({ secureContext: false, broadcastChannel: false, indexedDB: false })
